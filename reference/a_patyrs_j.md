...
- `s_patyrs_j()` returns a list containing the patient years statistics.
  The list of available statistics for can be viewed by running
  `junco_get_stats("a_patyrs_j")`. Currently, this is just a single
  statistic `patyrs`, patient years of exposure.
