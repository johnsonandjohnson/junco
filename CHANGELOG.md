...
## [0.1.2](https://github.com/johnsonandjohnson/junco/releases/tag/v0.1.2) - 2025-12-10
...
- Add functionality to
  ...
  that allows to exclude the analysis from specified row splits. \#95
- Add
  ...
  that allows to exclude the analysis from specified row splits. \#97
...
- Add extra check for existence of `.alt_df_full` when layout has risk
  difference column and a row-split (h_create_alt_df) \#120.
...
- Removed `s_test_proportion_diff()` and corresponding helper functions,
  as they are now available as needed in the `tern` package.
...
- Consistent
  ...
  function behavior with invalid structures \#116
