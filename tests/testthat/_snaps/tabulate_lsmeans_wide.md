...
# summarize_lsmeans_wide works as expected with more than 1 treatment group
    ...
    Output
             ...
             Treatment   N    LS Mean    SE    Treatment   N    LS Mean    SE    M. S. Error   Error DF   LS Mean    SE       80% CI      2-sided p-value~[super a]
      —————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
      VIS1      PBO      68    33.0     1.06      TRT      66    36.5     1.06      74.3         194        3.5     1.51   (1.41, 5.53)             0.044          
                                                 TRT2      66    37.5     1.06                              4.4     1.51   (2.36, 6.48)             0.008          
      
      VIS2      PBO      69    37.6     0.87      TRT      71    41.9     0.86      51.7         205        4.3     1.23   (2.58, 5.94)             0.001          
                                                 TRT2      71    42.4     0.86                              4.8     1.23   (3.12, 6.47)            <0.001          
      
      VIS3      PBO      71    43.6     0.83      TRT      58    46.6     0.91      47.6         181        3.0     1.25   (1.25, 4.65)             0.036          
                                                 TRT2      58    49.2     0.91                              5.5     1.25   (3.85, 7.24)            <0.001          
      
      VIS4      PBO      67    48.5     1.40      TRT      67    52.2     1.39      129.6        195        3.7     1.98   (1.04, 6.45)             0.111          
                                                 TRT2      67    52.9     1.39                              4.4     1.98   (1.68, 7.08)             0.054          
...
# summarize_lsmeans_wide can omit variance and p-value columns
    ...
    Output
                     Reference Group                    Testing Group                 Testing - Reference     
             Treatment   N    LS Mean    SE    Treatment   N    LS Mean    SE    LS Mean    SE       80% CI   
      ————————————————————————————————————————————————————————————————————————————————————————————————————————
      VIS1      PBO      68    33.2     0.82      TRT      66    36.8     0.79     3.7     1.13   (1.80, 5.56)
      
      VIS2      PBO      69    38.0     0.63      TRT      71    42.3     0.61     4.2     0.88   (2.79, 5.70)
      
      VIS3      PBO      71    43.8     0.47      TRT      58    46.8     0.52     3.1     0.70   (1.89, 4.22)
      
      VIS4      PBO      67    48.7     1.22      TRT      67    52.5     1.19     3.9     1.70   (1.07, 6.71)
