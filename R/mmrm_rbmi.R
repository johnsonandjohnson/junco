...
#' @param vars (`vars`)\cr list as generated by the set_vars() function from the rbmi package. Only the `subjid`, `group`,
...
#'
#' In order to meet the formatting standards set by the analyse() function from the rbmi package, the results will be collapsed
