...
#' @param ref_path (`character`)\cr global reference group specification, see [get_ref_info()].
...
#' @param is_event (`character`)\cr variable name storing Logical values: `TRUE` if event,
...
#' @param riskdiff (`flag`)\cr whether a risk difference column is present. When set to `TRUE`, [tern::add_riskdiff()] must be
...
#'
#' @keywords internal
#' @name proposal_argument_convention
NULL
