...
#' `> 2000` samples generated by the draws() function from the rbmi package. Conversely using
#' parallelisation if your samples are smaller than this may lead to longer run times than just
