...
gen_files <- identical(Sys.getenv("NOT_CRAN"), "true")
```
...
```{r orientation_docx, eval = gen_files}
...
```{r fontsize_docx, eval = gen_files}
export_as_docx_j(result,
...
```{r custom_border_matrix, eval = gen_files}
tt_to_tlgrtf(result,
...
```{r custom_border_matrix_docx, eval = gen_files}
export_as_docx_j(result,
...
```{r multiple_docs_table1, eval = gen_files}
################################################################################
...
```{r multiple_docs_table2, eval = gen_files}
################################################################################
# Convert to tbl file and output table
################################################################################
...
```{r multiple_docs_table3, eval = gen_files}
################################################################################
# Convert to tbl file and output table
################################################################################
...
```{r split_listing_docx_part1, eval = gen_files}
...
### Listing .docx File 2
```{r split_listing_docx_part2, eval = gen_files}
