...
result <- set_titles(result, titles)
tt_to_tlgrtf(result,
             file = paste0(tempdir(), "/bordertable"),
             orientation = "landscape")
```

### Visual Output (HTML Representation)
> **Note:** If this screenshot is the output of tt_to_flextable_j(), the bottom borders don't have the little separation when having 2 consecutive spanning headers. However, if you output the .docx file using the same tabletree as input, it should be displayed correctly.
...
tt_to_tlgrtf(result,
             file = paste0(tempdir(), "/custombordertable"),
             orientation = "landscape",
...
result <- set_titles(result, titles)
tt_to_tlgrtf(result,
             file = paste0(tempdir(), "/superscripttable"),
             orientation = "landscape",
