...
tt_to_flextable_j(result, "newlinetable",
  orientation = "landscape",
...
tt_to_flextable_j(result, "examplelistingnewline2",
  orientation = "landscape",
  string_map = string_map_newline
)
```
...
tt_to_tlgrtf(
  string_map = string_map, tt = result,
...
x <- tt_to_flextable_j(
  string_map = string_map, tt = result, "aetablemultipledocs2", orientation = "landscape",
...
x <- tt_to_flextable_j(
  string_map = string_map, tt = result, "aetablemultipledocs3", orientation = "landscape",
...
```{r page_break_table_display_part2, echo=FALSE, fig.align="center", out.width="100%", out.height="200px"}
