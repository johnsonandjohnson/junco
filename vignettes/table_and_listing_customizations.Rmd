...
```{r orientation_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
To create a .docx file with landscape orientation, the `junco::export_TLG_as_docx` function can be called with the `orientation` argument set to "landscape".

```{r orientation_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
...
```{r orientation_rtf_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r fontsize_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
To display the body of tables in Times New Roman 8-pt for .docx files, the junco::export_TLG_as_docx function can be called with the theme argument included. The theme argument will specify a junco::theme_docx_default_j function call.

```{r fontsize_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
export_TLG_as_docx(result,
...
### Visual Output (HTML Representation)
```{r fontsize_rtf_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r spanning_header_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
### Visual Output (HTML Representation)
```{r spanning_header_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r combined_column1_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
### Visual Output (HTML Representation)
```{r combined_column_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r combined_column2_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
### Visual Output (HTML Representation)
```{r improved_combined_column_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r newline_table_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
```{r newline_table_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
export_TLG_as_docx(result,
...
### Visual Output (HTML Representation)
```{r newline_table_rtf_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r newline_listing_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
```{r newline_listing_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
export_TLG_as_docx(result,
...
### Visual Output (HTML Representation)
```{r newline_listing_rtf_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r border_matrix_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
### Visual Output (HTML Representation)
```{r border_matrix_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r custom_border_matrix_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
### Table .docx File
To export a table with a custom border matrix to a .docx file, the `junco::export_TLG_as_docx` function can be called with the `border_mat` argument:

```{r custom_border_matrix_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
export_TLG_as_docx(result,
...
```{r custom_border_matrix_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r superscript_table_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
The default markup file for `junco::export_TLG_as_docx` to produce a .docx file is as follows.

```{r default_markup_docx2}
library(tibble)
...
If a .docx file is to be created for the table, the `junco::export_TLG_as_docx` is to be called. For .docx files, the markup is different from .rtf files. In this example, when calling `junco::export_TLG_as_docx`, the "markup_df_docx" argument has the default "docx_markup_df" object specified.
...
```{r superscript_table_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
export_TLG_as_docx(result,
...
### Visual Output (HTML Representation)
```{r superscript_table_rtf_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r superscript_listing_rtf_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
```{r superscript_listing_docx_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
export_TLG_as_docx(result,
...
```
### Visual Output (HTML Representation)
```{r superscript_listing_rtf_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r multiple_docs_data_prep, eval=NOT_CRAN}
library(tern)
library(dplyr)
library(rtables)
library(junco)
...
```{r multiple_docs_table1, eval=NOT_CRAN}
################################################################################
...
```{r multiple_docs_table1_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
...
### Visual Output (HTML Representation)
```{r multiple_docs_table1_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r multiple_docs_table2, eval=NOT_CRAN}
################################################################################
# Convert to tbl file and output table
################################################################################
...
```{r multiple_docs_table2_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(string_map = string_map, tt = result,
...
### Visual Output (HTML Representation)
```{r multiple_docs_table2_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r multiple_docs_table3_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(string_map = string_map, tt = result,
...
### Visual Output (HTML Representation)
```{r multiple_docs_table3_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r page_break_table_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
tt_to_tlgrtf(result,
...
```{r page_break_table_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r page_break_table_display_part2, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r split_listing_part1_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
...
### Listing .docx File
The `junco::export_TLG_as_docx` function can be called multiple times to produce multiple .docx files, similar to the approach used for .rtf files:

```{r split_listing_docx_part1_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
...
### Visual Output (HTML Representation)
```{r split_listing_part1_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
...
```{r split_listing_part2_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
...
### Listing .docx File 2
```{r split_listing_docx_part2_export, eval=NOT_CRAN, message=FALSE, warning=FALSE}
...
### Visual Output (HTML Representation)
```{r split_listing_part2_display, echo=FALSE, eval=NOT_CRAN, fig.align="center", out.width="100%", out.height="200px"}
